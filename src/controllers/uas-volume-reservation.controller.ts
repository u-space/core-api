  ...
  private convertAnyToUVR(obj: any): UASVolumeReservation {
    validateObjectKeys(
      ...
      [
        ...
        { name: "permitted_uas", type: ObjectKeyType.OTHER },
        { name: "required_support", type: ObjectKeyType.OTHER },
        { name: "permitted_operations", type: ObjectKeyType.OTHER },
        { name: "permitted_gufis", type: ObjectKeyType.OTHER },
